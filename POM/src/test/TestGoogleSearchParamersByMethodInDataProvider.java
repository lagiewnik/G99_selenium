...
public class TestGoogleSearchParamersByMethodInDataProvider {
		WebDriver driver;
		...
		@Test(dataProvider="SearchProvider",dataProviderClass=parameters.DataproviderByMethodClass.class)
